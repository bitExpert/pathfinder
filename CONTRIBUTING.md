...
If you wish to contribute to Pathfinder, please be sure to
read/subscribe to the following resources:

 -  [The PSR-2 Coding Standard](http://www.php-fig.org/psr/psr-2/)

If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/pathfinder/issues/new).
...
```console
$ git clone git@github.com:bitExpert/pathfinder.git
$ cd pathfinder
```
...
2. Fork the repository (http://github.com/bitExpert/pathfinder)
...
```console
$ git remote add {username} git@github.com:{username}/pathfinder.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical Pathfinder repository.
...
To ssh://git@github.com/{username}/pathfinder.git
